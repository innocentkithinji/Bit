...
import com.innocent.bit.IBitService;
...
import com.innocent.bit.subfragments.QuickControlsFragment;
...
import static com.innocent.bit.MusicPlayer.mService;
...
public class BaseActivity extends ATEActivity implements ServiceConnection, MusicStateListener {
    ...
    public void onServiceConnected(final ComponentName name, final IBinder service) {
        mService = IBitService.Stub.asInterface(service);
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        if (!BitUtils.hasEffectsPanel(BaseActivity.this)) {
