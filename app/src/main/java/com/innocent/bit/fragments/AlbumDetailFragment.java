 ...
 */
package com.innocent.bit.fragments;
...
import com.innocent.bit.adapters.AlbumSongsAdapter;
import com.innocent.bit.dataloaders.AlbumLoader;
import com.innocent.bit.dataloaders.AlbumSongLoader;
import com.innocent.bit.listeners.SimplelTransitionListener;
import com.innocent.bit.models.Album;
import com.innocent.bit.models.Song;
import com.innocent.bit.utils.ATEUtils;
import com.innocent.bit.utils.Constants;
import com.innocent.bit.utils.FabAnimationUtils;
import com.innocent.bit.utils.Helpers;
import com.innocent.bit.utils.NavigationUtils;
import com.innocent.bit.utils.PreferencesUtility;
import com.innocent.bit.utils.SortOrder;
import com.innocent.bit.utils.BitUtils;
import com.innocent.bit.widgets.DividerItemDecoration;
...
public class AlbumDetailFragment extends Fragment {
            ...
            public void onClick(View v) {
                ...
                handler.postDelayed(new Runnable() {
                    ...
                    public void run() {
                        ...
                        MusicPlayer.playAll(getActivity(), adapter.getSongIds(), 0, albumID, BitUtils.IdType.Album, true);
    ...
    private void setAlbumart() {
        ImageLoader.getInstance().displayImage(BitUtils.getAlbumArtUri(albumID).toString(), albumArt,
                new DisplayImageOptions.Builder().cacheInMemory(true)
                    ...
                    public void onLoadingFailed(String imageUri, View view, FailReason failReason) {
                        ...
                        MaterialDrawableBuilder builder = MaterialDrawableBuilder.with(context)
                                ...
                                .setColor(BitUtils.getBlackWhiteColor(Config.accentColor(context, Helpers.getATEKey(context))));
                            ...
                            new Palette.Builder(loadedImage).generate(new Palette.PaletteAsyncListener() {
                                                                          ...
                                                                          public void onGenerated(Palette palette) {
                                                                              ...
                                                                              MaterialDrawableBuilder builder = MaterialDrawableBuilder.with(getActivity())
                                                                                      ...
                                                                                      .setSizeDp(30);
                                                                              if (primaryColor != -1) {
                                                                                  builder.setColor(BitUtils.getBlackWhiteColor(primaryColor));
                                                                                  ATEUtils.setFabBackgroundTint(fab, primaryColor);
                                                                                  fab.setImageDrawable(builder.build());
                                                                              } else {
                                                                                  if (context != null) {
                                                                                      ATEUtils.setFabBackgroundTint(fab, Config.accentColor(context, Helpers.getATEKey(context)));
                                                                                      builder.setColor(BitUtils.getBlackWhiteColor(Config.accentColor(context, Helpers.getATEKey(context))));
                                                                                      fab.setImageDrawable(builder.build());
                                                                                  }
                                                                              }
                                                                          }
    ...
    private void setAlbumDetails() {
        ...
        String songCount = BitUtils.makeLabel(getActivity(), R.plurals.Nsongs, album.songCount);
