...
package com.innocent.bit.subfragments;
...
import com.innocent.bit.activities.DonateActivity;
...
public class SubStyleSelectorFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container,
        ...
        switch (getArguments().getInt(ARG_PAGE_NUMBER)) {
            case 0:
                styleImage.setImageResource(R.drawable.bit_1_nowplaying_x);
                break;
            case 1:
                styleImage.setImageResource(R.drawable.bit_2_nowplaying_x);
                break;
            case 2:
                styleImage.setImageResource(R.drawable.bit_3_nowplaying_x);
                break;
            case 3:
                styleImage.setImageResource(R.drawable.bit_4_nowplaying_x);
                break;
            case 4:
                styleImage.setImageResource(R.drawable.bit_5_nowplaying_x);
                break;
            case 5:
                styleImage.setImageResource(R.drawable.bit_6_nowplaying_x);
                break;
        }
