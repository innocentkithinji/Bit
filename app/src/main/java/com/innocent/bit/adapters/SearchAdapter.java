...
package com.innocent.bit.adapters;
...
import com.innocent.bit.dialogs.AddPlaylistDialog;
import com.innocent.bit.lastfmapi.LastFmClient;
import com.innocent.bit.lastfmapi.callbacks.ArtistInfoListener;
import com.innocent.bit.lastfmapi.models.ArtistQuery;
import com.innocent.bit.lastfmapi.models.LastfmArtist;
    ...
    public void onBindViewHolder(final ItemHolder itemHolder, int i) {
        switch (getItemViewType(i)) {
            case 0:
                ...
                ImageLoader.getInstance().displayImage(BitUtils.getAlbumArtUri(song.albumId).toString(), itemHolder.albumArt,
            ...
            case 1:
                ...
                ImageLoader.getInstance().displayImage(BitUtils.getAlbumArtUri(album.id).toString(), itemHolder.albumArt,
                        new DisplayImageOptions.Builder().cacheInMemory(true)
                                .cacheOnDisk(true)
                                .showImageOnFail(R.drawable.ic_empty_music2)
                                .resetViewBeforeLoading(true)
            ...
            case 2:
                ...
                itemHolder.albumsongcount.setText(BitUtils.makeCombinedString(mContext, albumNmber, songCount));
                    ...
                    public boolean onMenuItemClick(MenuItem item) {
                        ...
                        switch (item.getItemId()) {
                            case R.id.popup_song_play:
                                MusicPlayer.playAll(mContext, song, 0, -1, BitUtils.IdType.NA, false);
                                break;
                            case R.id.popup_song_play_next:
                                MusicPlayer.playNext(mContext, song, -1, BitUtils.IdType.NA);
                                break;
                            ...
                            case R.id.popup_song_addto_queue:
                                MusicPlayer.addToQueue(mContext, song, -1, BitUtils.IdType.NA);
                                break;
                ...
                case 0:
                    ...
                    handler.postDelayed(new Runnable() {
                        ...
                        public void run() {
                            ...
                            MusicPlayer.playAll(mContext, ret, 0, -1, BitUtils.IdType.NA, false);
                        }
                    }, 100);
