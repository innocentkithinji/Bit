                            ...
                            new Palette.Builder(loadedImage).generate(new Palette.PaletteAsyncListener() {
                                ...
                                public void onGenerated(Palette palette) {
                                    ...
                                    if (swatch != null) {
                                        ...
                                        int textColor = BitUtils.getBlackWhiteColor(swatch.getTitleTextColor());
                                        ...
                                        if (mutedSwatch != null) {
                                            ...
                                            itemHolder.footer.setBackgroundColor(color);
                                            int textColor = BitUtils.getBlackWhiteColor(mutedSwatch.getTitleTextColor());
                                            itemHolder.title.setTextColor(textColor);
                                            itemHolder.artist.setTextColor(textColor);
                                        }
                                    }
                ...
                switch (position) {
                    case 0:
                        ...
                        if (songCountInt != 0) {
                            ...
                            return BitUtils.getAlbumArtUri(firstAlbumID).toString();
                        } else return "nosongs";
                    case 1:
