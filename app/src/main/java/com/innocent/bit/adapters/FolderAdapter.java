...
import com.innocent.bit.dataloaders.FolderLoader;
...
public class FolderAdapter extends RecyclerView.Adapter<FolderAdapter.ItemHolder> implements BubbleTextGetter {
    ...
    public void onBindViewHolder(final FolderAdapter.ItemHolder itemHolder, int i) {
        ...
        if (localItem.isDirectory()) {
            ...
            ImageLoader.getInstance().displayImage(BitUtils.getAlbumArtUri(song.albumId).toString(),
                    itemHolder.albumArt,
            ...
            if (f.isDirectory() && updateDataSetAsync(f)) {
                ...
                handler.postDelayed(new Runnable() {
                    ...
                    public void run() {
                        ...
                        MusicPlayer.playAll(mContext, ret, current, -1, BitUtils.IdType.NA, false);
                    }
                }, 100);
