...
public class ArtistAdapter extends RecyclerView.Adapter<ArtistAdapter.ItemHolder> implements BubbleTextGetter {
    ...
    public void onBindViewHolder(final ItemHolder itemHolder, int i) {
        ...
        String albumNmber = BitUtils.makeLabel(mContext, R.plurals.Nalbums, localItem.albumCount);
        String songCount = BitUtils.makeLabel(mContext, R.plurals.Nsongs, localItem.songCount);
        itemHolder.albums.setText(BitUtils.makeCombinedString(mContext, albumNmber, songCount));
