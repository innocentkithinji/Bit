...
public class AlbumSongsAdapter extends RecyclerView.Adapter<AlbumSongsAdapter.ItemHolder> {
    ...
    public void onBindViewHolder(ItemHolder itemHolder, int i) {
        ...
        itemHolder.duration.setText(BitUtils.makeShortTimeString(mContext, (localItem.duration) / 1000));
                    ...
                    public boolean onMenuItemClick(MenuItem item) {
                        switch (item.getItemId()) {
                            ...
                            case R.id.popup_song_delete:
                                ...
                                BitUtils.showDeleteDialog(mContext,arraylist.get(position).title, deleteIds, AlbumSongsAdapter.this, position);
                                break;
                        }
                        return false;
                    }
    ...
    public class ItemHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        ...
        public void onClick(View v) {
            ...
            handler.postDelayed(new Runnable() {
                @Override
                public void run() {
                    MusicPlayer.playAll(mContext, songIDs, getAdapterPosition(), albumID, BitUtils.IdType.Album, false);
