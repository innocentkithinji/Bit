...
public class MusicPlaybackTrack implements Parcelable {
    ...
    public BitUtils.IdType mSourceType;
    public int mSourcePosition;

    public MusicPlaybackTrack(long id, long sourceId, BitUtils.IdType type, int sourcePosition) {
        mId = id;
        mSourceId = sourceId;
        mSourceType = type;
    ...
    public MusicPlaybackTrack(Parcel in) {
        ...
        mSourceType = BitUtils.IdType.getTypeById(in.readInt());
