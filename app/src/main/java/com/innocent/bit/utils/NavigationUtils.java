...
package com.innocent.bit.utils;
...
import com.innocent.bit.activities.MainActivity;
import com.innocent.bit.activities.NowPlayingActivity;
import com.innocent.bit.activities.PlaylistDetailActivity;
import com.innocent.bit.activities.SearchActivity;
import com.innocent.bit.activities.SettingsActivity;
import com.innocent.bit.fragments.AlbumDetailFragment;
import com.innocent.bit.fragments.ArtistDetailFragment;
import com.innocent.bit.nowplaying.Bit1;
import com.innocent.bit.nowplaying.Bit2;
import com.innocent.bit.nowplaying.Bit3;
import com.innocent.bit.nowplaying.Bit4;
import com.innocent.bit.nowplaying.Bit5;
import com.innocent.bit.nowplaying.Bit6;
...
public class NavigationUtils {
    ...
    public static void navigateToAlbum(Activity context, long albumID, Pair<View, String> transitionViews) {
        ...
        if (BitUtils.isLollipop() && transitionViews != null && PreferencesUtility.getInstance(context).getAnimations()) {
    ...
    public static void navigateToPlaylistDetail(Activity context, String action, long firstAlbumID, String playlistName, int foregroundcolor, long playlistID, ArrayList<Pair> transitionViews) {
        ...
        if (transitionViews != null && BitUtils.isLollipop() && PreferencesUtility.getInstance(context).getAnimations()) {
    ...
    public static void navigateToEqualizer(Activity context) {
        try {
            ...
            context.startActivityForResult(BitUtils.createEffectsIntent(), 666);
