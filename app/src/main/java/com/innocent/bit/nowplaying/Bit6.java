...
import com.innocent.bit.widgets.CircleImageView;
...
public class Bit6 extends BaseNowplayingFragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        View rootView = inflater.inflate(
                R.layout.fragment_bit6, container, false);
    ...
    public void onMetaChanged() {
        ...
        if (getActivity() != null) {
            ...
            nextArt.setImageURI(BitUtils.getAlbumArtUri(next.albumId));
        }
    }
}
